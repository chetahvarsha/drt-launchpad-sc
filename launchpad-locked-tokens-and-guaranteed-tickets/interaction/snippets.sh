...
ADDRESS="drt1qqqqqqqqqqqqqpgqv70gqyr2tr2vqfrxxre6wzytt7nfcuyupr9s7f4t8w"
...
SIMPLE_LOCK_ADDRESS="drt1qqqqqqqqqqqqqpgqxsyrdj38fclflak2mwtqdknqzqhuxy4s0n4s9dwv36"
...
deploy() {
    ...
    drtpy --verbose contract deploy --bytecode="../output/launchpad-locked-tokens-and-guaranteed-tickets.wasm" --recall-nonce --pem=${OWNER_PEM_PATH} \
    --gas-limit=200000000 \
