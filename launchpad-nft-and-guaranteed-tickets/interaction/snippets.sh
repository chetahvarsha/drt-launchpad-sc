...
ADDRESS="drt1qqqqqqqqqqqqqpgqptlxkvh3djyq2x3adf00pgtlrdl4czmrad7qxrwr2w"
...
deploy() {
    ...
    drtpy --verbose contract deploy --bytecode="../output/launchpad-nft-and-guaranteed-tickets.wasm" --recall-nonce --pem=${OWNER_PEM_PATH} \
    --gas-limit=200000000 \
