...
fn confirm_test() {
    ...
    lp_setup
        .b_mock
        .set_rewa_balance(&users[0], &rust_biguint!(1_000_000_000));
    lp_setup
        .confirm_nft(&users[0])
...
fn claim_test() {
    ...
    lp_setup
        .b_mock
        .check_rewa_balance(&users[0], &rust_biguint!(0));
    lp_setup
        .b_mock
        .check_rewa_balance(&users[1], &rust_biguint!(initial_balance));
    lp_setup
        .b_mock
        .check_rewa_balance(&users[2], &rust_biguint!(initial_balance));
    ...
    lp_setup
        .b_mock
        .check_rewa_balance(&lp_setup.owner_address, &rust_biguint!(NFT_TICKET_COST));
